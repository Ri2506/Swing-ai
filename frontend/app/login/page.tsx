      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 mb-6 bg-white text-gray-900 rounded-xl font-medium hover:bg-gray-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isGoogleLoading ? (
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  {...register('remember')}
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-700 bg-background-elevated text-primary focus:ring-2 focus:ring-primary/20"
                />
