    ...
    >
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2">
          {plan.name === 'free' && <Zap className="w-5 h-5 text-gray-400" />}
        ...
        <p className={`text-sm ${isPopular ? 'text-blue-100' : 'text-gray-400'}`}>
          {plan.description}
        </p>
      </div>
      ...
      <div className="mb-6">
        <div className="flex items-baseline gap-1">
          ...
          <span className={isPopular ? 'text-blue-100' : 'text-gray-400'}>/month</span>
        </div>
        {billingPeriod !== 'monthly' && (
          <div className="mt-1">
            <span className={`text-sm ${isPopular ? 'text-blue-100' : 'text-gray-400'}`}>
      ...
      <ul className="space-y-3 mb-8">
        {features.map((feature, i) => (
          <li key={i} className="flex items-center gap-2">
            ...
            <span className={
              feature.included
                ? isPopular ? 'text-blue-50' : 'text-gray-300'
  ...
  return (
    <div className="min-h-screen bg-black text-white py-20">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center p-1 bg-gray-900 rounded-xl border border-gray-800">
