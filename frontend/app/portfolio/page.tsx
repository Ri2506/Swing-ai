        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/dashboard"
                className="px-4 py-2 bg-background-elevated border border-gray-800 rounded-lg text-text-secondary hover:text-text-primary hover:border-gray-700 transition-all"
              >
                Back to Dashboard
              </Link>
              <button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <motion.div
              ...
              className="p-4 rounded-xl bg-background-elevated border border-gray-800"
            >
                      ...
                      <div className="flex items-center gap-4">
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="px-2 py-1 rounded text-xs bg-gray-800 text-text-secondary">
                              {position.segment}
                            </span>
                          </div>
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2">
                          <Link
                            ...
                            className="p-2 rounded-lg bg-background-elevated border border-gray-800 hover:border-gray-700 transition-colors"
                          >
