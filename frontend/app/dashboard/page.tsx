...
export default function DashboardPage() {
  ...
  const mappedSignals = signals.map(s => ({
    id: s.id,
    symbol: s.symbol,
    exchange: (s.exchange || 'NSE') as 'NSE' | 'BSE',
  ...
  const mappedPositions = positions.map(p => ({
    ...
    signal_id: p.id,
    symbol: p.symbol,
    exchange: (p.exchange || 'NSE') as 'NSE' | 'BSE',
  ...
  return (
    <div className="min-h-screen bg-background-primary">
      {/* Top Navigation Bar */}
      <nav className="fixed top-0 left-0 right-0 z-40 bg-background-surface/80 backdrop-blur-xl border-b border-gray-800">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-background-elevated border border-gray-800 rounded-xl text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
              />
            </div>
          </div>
      ...
      {/* Sidebar Navigation */}
      <aside className={`fixed left-0 top-16 bottom-0 z-30 w-64 bg-background-surface border-r border-gray-800 transition-transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-4">
              ...
              {mappedSignals.length > 0 ? (
                ...
                <div className="p-8 bg-background-surface rounded-2xl border border-gray-800 text-center">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {mappedPositions.length > 0 ? (
                    ...
                    <div className="p-6 bg-background-surface rounded-xl border border-gray-800 text-center">
