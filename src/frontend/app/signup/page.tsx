    ...
    <div className="min-h-screen bg-background-primary flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-background-surface/50 backdrop-blur-xl rounded-2xl border border-gray-800 p-8 shadow-2xl"
        >
            ...
            {step === 1 && (
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-6 py-3 mb-6 bg-white text-gray-900 rounded-xl font-medium hover:bg-gray-100 transition-all disabled:opacity-50"
                >
                  {isGoogleLoading ? (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-background-elevated border border-gray-800 rounded-xl text-text-primary placeholder:text-text-muted focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                      />
                    </div>
                    {errors.full_name && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full pl-12 pr-12 py-3 bg-background-elevated border border-gray-800 rounded-xl text-text-primary placeholder:text-text-muted focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                      />
                      <button
                        type="button"
              ...
              >
                      ...
                      <motion.button
                        ...
                        className={`relative p-6 rounded-xl border-2 text-left transition-all ${
                          selectedPlan === plan.id
                            ...
                            : 'border-gray-800 bg-background-elevated hover:border-gray-700'
                        }`}
                      >
                        {plan.popular && (
                ...
                <div className="flex gap-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => setStep(1)}
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-background-elevated text-text-primary rounded-xl font-medium border border-gray-800 hover:border-gray-700 transition-all"
                  >
