...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-gray-900 border-r border-gray-800 transform transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-800">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => signOut()}
              className="flex items-center justify-center gap-2 px-3 py-2 bg-gray-800 hover:bg-red-500/20 hover:text-red-500 rounded-lg text-sm text-gray-300 transition-colors"
            >
