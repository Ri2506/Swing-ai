  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400 mt-1">Payment transactions and revenue analytics</p>
      </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Last {statsPeriod} days</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">{stats?.refunds_count || 0} refunds</p>
            </div>
      ...
      <div className="bg-gray-900 rounded-2xl border border-gray-800 p-4">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-gray-800 hover:bg-gray-700 rounded-lg text-gray-400 transition-colors flex items-center gap-2"
          >
                ...
                {payments.map((payment) => (
                  <tr key={payment.id} className="hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="px-4 py-4">
                      ...
                      <p className="text-gray-500 text-xs capitalize">{payment.billing_period}</p>
                    </td>
                    <td className="px-4 py-4">
                    ...
                    <td className="px-4 py-4">
                      <code className="text-gray-400 text-xs bg-gray-800 px-2 py-1 rounded">
