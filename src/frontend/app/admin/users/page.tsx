    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-white text-sm font-medium transition-colors"
        >
        ...
        <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder:text-gray-500 focus:outline-none focus:border-red-500"
            />
          </div>
          <select
          ...
          <button
            type="submit"
            className="px-6 py-2.5 bg-red-500 hover:bg-red-600 rounded-lg text-white font-medium transition-colors"
          >
            Search
          </button>
          <button
                              ...
                              <>
                                {user.is_suspended ? (
                                  ...
                                  <button
                                    ...
                                    className="w-full flex items-center gap-2 px-4 py-2 text-sm text-yellow-400 hover:bg-gray-700 transition-colors"
                                  >
