...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-background-primary">
      {/* Header */}
      <header className="bg-background-surface border-b border-gray-800">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-background-surface rounded-2xl border border-gray-800 p-6">
              {/* Profile Tab */}
              {activeTab === 'profile' && (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-background-elevated border border-gray-700 rounded-xl text-text-primary focus:outline-none focus:border-primary"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={user?.email || ''}
                        disabled
                        className="w-full px-4 py-3 bg-background-elevated border border-gray-700 rounded-xl text-text-muted cursor-not-allowed"
                      />
                    </div>
                    <div>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 bg-background-elevated border border-gray-700 rounded-lg text-text-primary focus:outline-none focus:border-primary"
                          />
                        </div>
                        <div>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            tradingForm.fo_enabled ? 'bg-primary' : 'bg-gray-600'
                          }`}
                        >
                    ...
                    <div className="flex items-center justify-between p-4 bg-background-elevated rounded-xl">
                      ...
                      <button
                        ...
                        className={`w-12 h-6 rounded-full transition-colors ${
                          tradingForm.trailing_sl_enabled ? 'bg-primary' : 'bg-gray-600'
                        }`}
                      >
                        <div className={`w-5 h-5 rounded-full bg-white transition-transform ${
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 bg-background-elevated rounded-xl">
                      ...
                      <button
                        ...
                        className={`w-12 h-6 rounded-full transition-colors ${
                          notificationForm.notifications_enabled ? 'bg-primary' : 'bg-gray-600'
                        }`}
                      >
                        <div className={`w-5 h-5 rounded-full bg-white transition-transform ${
                        ...
                        <div className="p-4 bg-background-elevated rounded-xl space-y-3">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className={`w-10 h-5 rounded-full transition-colors ${
                                notificationForm.email_signals ? 'bg-primary' : 'bg-gray-600'
                              }`}
                            >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className={`w-10 h-5 rounded-full transition-colors ${
                                notificationForm.email_trades ? 'bg-primary' : 'bg-gray-600'
                              }`}
                            >
                              <div className={`w-4 h-4 rounded-full bg-white transition-transform ${
                        ...
                        <div className="p-4 bg-background-elevated rounded-xl space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className={`w-10 h-5 rounded-full transition-colors ${
                                notificationForm.telegram_enabled ? 'bg-primary' : 'bg-gray-600'
                              }`}
                            >
                              <div className={`w-4 h-4 rounded-full bg-white transition-transform ${
                          ...
                          {notificationForm.telegram_enabled && (
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-3 py-2 bg-background-primary border border-gray-700 rounded-lg text-text-primary text-sm focus:outline-none focus:border-primary"
